...
### 1.5️⃣ Cowork & 웹 앱 활용하기

입문 이후 빠르게 시도해볼 수 있는 중간 단계입니다. 터미널 없이도 강력한 기능을 쓸 수 있습니다.

**Claude Desktop 앱의 Cowork 탭:**
- 파일을 끌어다 놓고 AI와 공동 작업
- 실시간으로 문서, 코드, 데이터를 같이 편집
- 브랜치나 Git 없이도 버전 관리처럼 작업 가능

**웹 앱 (claude.ai/code):**
- 설치 없이 브라우저에서 바로 Claude Code 기능 사용
- 어느 기기에서나 동일한 환경
...
여러 AI를 동시에 운영해서 복잡한 작업을 자동으로 처리합니다. 현재 실험적(Experimental) 단계로, `settings.json`에서 활성화할 수 있습니다.
...
**학습 콘텐츠:**
```
✅ AI Agent 아키텍처 — 여러 AI를 동시 운영 (실험적 기능)
✅ 복잡한 워크플로우 설계 — 자동화 시스템 구축
✅ 에러 처리 및 모니터링 — 안정적 운영
✅ 원격 제어 & 세션 이전 — --remote, --teleport 활용
...
- **Opus 4.7 + xhigh 노력 수준** (2026-04-16) — 코딩 10-14% 향상, 이미지 해상도 3배
