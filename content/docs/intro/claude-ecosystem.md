...
| 공간 | 한마디 설명 | 누구를 위한 건가? |
|------|-----------|-----------------|
| **Claude 웹앱** (claude.ai) | 브라우저에서 채팅 + 문서 작성 | 모든 사람 (왕초보) |
| **코워크** (Cowork) | 내 컴퓨터를 AI가 직접 조작 | 사무직·자영업자·은퇴 후 인생 2막 |
| **Claude Code** (터미널) | 코드 작성·수정·자동화 도구 | 클로드 중급 세션 · 심화 학습자 |
| **Claude Code 웹** (claude.ai/code) | 브라우저에서 코딩 | 클로드 심화 학습자 |
