...
11:["$","$Lf",null,{"href":"/docs/reference","className":"breadcrumb-link shrink-0","children":"레퍼런스"}]
12:["$","span","1",{"className":"flex items-center gap-2 min-w-0","children":[["$","span",null,{"style":{"color":"var(--border)","fontSize":"16px"},"children":"/"}],["$","span",null,{"className":"font-medium truncate","style":{"color":"var(--text-primary)","fontSize":"14px"},"children":"전체 슬래시 커맨드 목록"}]]}]
13:["$","$L15",null,{}]
16:T2bca,<blockquote>
